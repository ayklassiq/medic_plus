...
import 'package:medic_plus/Views/Schedule_Appointment/phone_call_screen.dart';
...
class YourAppointment extends StatelessWidget {
  ...
  static const routeName = '/yourAppointment-screen';
                        ...
                        children: [
                          ...
                          SizedBox(
                              ...
                              child: NavigationButton(
                                  ...
                                  onPressed: () {
                                    Navigator.push(context, MaterialPageRoute(builder: (BuildContext ctx)=>const PhoneCall()));
